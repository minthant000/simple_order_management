            ...
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <h3 class="mb-3"><i class="fa-solid fa-database mr-2"></i> {{ $pizzas->total() }} </h3>
                        </div>
                        <div class="col-3 offset-3 mb-3">
                            <form action="{{ route('products#pizzalist') }}" method="GET">
                                @csrf
                                <div class="d-flex">
                    ...
                    @else
                        <h3 class="text-secondary text-center mt-5">There is no Items here!</h3>
                    @endif
