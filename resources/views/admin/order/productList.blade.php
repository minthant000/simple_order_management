            ...
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="table-responsive table-responsive-data2">
                        ...
                        <a href="{{ route('admin#orderList') }}" class="mb-2 text-decoration-none text-dark">
                        ...
                        <div class="row col-6">
                            <div class="card mt-4">
                                <div class="card-header" style="border-bottom:1px solid black">
                                    ...
                                    <small class="text-warning mt-3"><i class="fa-solid fa-triangle-exclamation"></i> Include Delivery Fees</small>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col"> <i class="fa-solid fa-circle-user me-2"></i>Customer Name</div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col"><i class="fa-solid fa-receipt me-2"></i>Total</div>
